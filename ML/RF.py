...
def ml(X, y, r): # Machine learning approach
    ...
    c = RandomForestClassifier(n_estimators=500,n_jobs=-1)
...
if __name__ == '__main__':
    ...
    excel_file_path = os.path.dirname(__file__) + '/../ML_Results/' + input_raw + '_RF.xlsx'
...
# REMOVE after all the following methods are introduced in the resampling methods (oversampling/undersampling)
    ...
    if debug:
        ...
        debug_folder_path = os.path.dirname(__file__) + '/../ML_Results/' + input + '/RF_debug'
        ...
        prename = debug_folder_path + '/RF_' + data_type + '_'
