...
if __name__ == '__main__':
    ...
    excel_file_path = os.path.dirname(__file__) + '/../ML_Results/' + input_raw + '_SGD.xlsx'
...
# REMOVE after all the following methods are introduced in the resampling methods (oversampling/undersampling)
    ...
    if debug:
        ...
        debug_folder_path = os.path.dirname(__file__) + '/../ML_Results/' + input + '/SGD_debug'
        ...
        prename = debug_folder_path + '/SGD_' + data_type + '_'
