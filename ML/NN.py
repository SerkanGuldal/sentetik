...
if __name__ == '__main__':
    ...
    excel_file_path = os.path.dirname(__file__) + '/../ML_Results/' + input_raw + '_NN.xlsx'
...
# REMOVE after all the following methods are introduced in the resampling methods (oversampling/undersampling)
    ...
    mean_acc_old = 0
    tolerance = 0.0001
    num_iterations = 2000  # Change this value to adjust the maxiumum number of iterations
    ...
    if debug:
        ...
        debug_folder_path = os.path.dirname(__file__) + '/../ML_Results/' + input + '/NN_debug'
        ...
        prename = debug_folder_path + '/NN_' + data_type + '_'
